...
namespace BuyTime_Infrastructure.Migrations
{
    ...
    [Migration("20260607170932_AddRefundRequestTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuyTime_Domain.Entities.BookingCancellation", b =>
                {
                    ...
                    b.Property<decimal>("CompensationAmountToExpert")
                    ...
                    b.Property<decimal>("RefundAmountToStudent")
                        .HasColumnType("decimal(18,9)");
            ...
            modelBuilder.Entity("BuyTime_Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BuyTime_Domain.Entities.RefundRequest", b =>
                {
                    b.Property<Guid>("BookingId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BuyTime_Domain.Entities.TransactionRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BuyTime_Domain.Entities.RefundRequest", b =>
                {
                    b.HasOne("BuyTime_Domain.Entities.Booking", "Booking")
                        ...
                        .HasForeignKey("BuyTime_Domain.Entities.RefundRequest", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
